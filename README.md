# Yash Sharma — Data Analytics Portfolio
...
I am a BCA graduate/fresher building practical skills in data analytics and data science.
...
### [Sales Report — Power BI Dashboard](https://github.com/yash6677sharma-spec/Sales-Report-Power-bi-dashboard)

A sales analytics dashboard covering sales performance, budget comparison, customers, products, categories, cities and monthly trends.
...
An e-commerce analytics project combining PostgreSQL data work with Power BI reporting.
...
A Tableau dashboard project focused on analyzing British Airways customer review data and presenting the results through interactive visualizations.
...
An AI and automation project exploring automated workflows for data analyst tasks.

**Tools:** AI, Automation, Data Analytics

---

# Project Portfolio Structure

Each project is maintained separately so that recruiters and other viewers can open the complete project, inspect the files, and review the work in detail.
